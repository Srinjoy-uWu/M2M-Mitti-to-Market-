...
public class TwoWayMatchingAndDealTest {
    ...
    static class InMemoryProduceRepository implements ProduceRepository {
        ...
        @Override
        public Optional<Produce> findByIdWithLock(Long id) { return findById(id); }
        @Override
        public List<Produce> findByStatusInAndExpiryDateBefore(List<Produce.ProduceStatus> statuses, java.time.LocalDate date) {
            return Collections.emptyList();
        }
        @Override
        public List<Produce> findByStatusInAndExpiryDateBetweenAndExpiryWarningSentFalse(
                List<Produce.ProduceStatus> statuses, java.time.LocalDate fromDate, java.time.LocalDate toDate) {
            return Collections.emptyList();
        }
        @Override
        public void flush() {}
